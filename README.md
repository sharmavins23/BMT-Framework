# Baremetal Teaching Framework

This is a framework for teaching Baremetal/Assembly programming on the Raspberry
Pi. Specifically, it provides driver and simplification code for all major
functions.
